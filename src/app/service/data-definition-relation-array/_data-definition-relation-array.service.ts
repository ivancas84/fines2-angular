...
export class _DataDefinitionRelationArrayService {
  /**
  ...
  main(entityName: string, id: string): Observable<string> {
    switch(entityName) {
      case "alumno": { return this.alumno(id); }
