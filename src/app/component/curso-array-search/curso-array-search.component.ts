...
@Component({
  selector: 'app-curso-array-search',
  templateUrl: './curso-array-search.component.html',
  styleUrls: ['./curso-array-search.component.css']
})
export class CursoArraySearchComponent implements OnInit {
